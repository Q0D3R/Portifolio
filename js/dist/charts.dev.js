...
document.addEventListener("DOMContentLoaded", function () {
  var ctx = document.getElementById('childrenBubbleChart').getContext('2d');
  new Chart(ctx, {
    type: 'bubble',
    data: {
      datasets: [{
        ...
        data: [{
          ...
          y: 7,
          r: 15
        }, // e.g., x: health score, y: checkup frequency, r: severity
        {
          x: 6,
          y: 5,
          r: 10
        ...
        data: [{
          ...
          y: 8,
          r: 18
        }, // x: test score, y: attendance, r: improvement
        {
          x: 7,
          y: 6,
          r: 12
        ...
        data: [{
          ...
          y: 9,
          r: 14
        }, // x: peer rating, y: activities, r: engagement
        {
          x: 6,
          y: 7,
          r: 10
        ...
        data: [{
          ...
          y: 6,
          r: 11
        }, // x: incidents, y: positive notes, r: improvement
        {
          x: 3,
          y: 5,
          r: 8
        ...
        tooltip: {
          callbacks: {
            label: function label(context) {
              var d = context.raw;
              return "x: ".concat(d.x, ", y: ").concat(d.y, ", size: ").concat(d.r);
            }
          }
        }
      },
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var ctx = document.getElementById('financeRingChart').getContext('2d'); // Create the ring (doughnut) chart
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  new Chart(ctx, {
    type: 'bar',
    data: {
      labels: ['Boarding', 'Sales', 'Donations', 'Inventory'],
      datasets: [{
        label: 'Expected/ Total',
        backgroundColor: '#4e79a7',
        data: [12000, 8000, 3500, 500] // Boarding Fees Expected, Sales Expected, Donations (N/A), Inventory Expected

      }, {
        label: 'Paid/ Received',
        backgroundColor: '#f28e2b',
        data: [9000, 6500, 2000, 350] // Boarding Fees Paid, Sales Paid, Donations In-Kind, Inventory Issued

      }, {
        label: 'Balance/ Cash',
        backgroundColor: '#e15759',
        data: [3000, 1500, 1500, 150] // Boarding Fees Balance, Sales Balance, Donations Cash, Inventory Balance
...
window.addEventListener('DOMContentLoaded', function () {
  var ctx = document.getElementById('farmSalesLineChart').getContext('2d');
